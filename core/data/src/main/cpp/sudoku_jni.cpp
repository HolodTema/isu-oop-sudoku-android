...
Java_com_terabyte_sudokucppgame_core_data_SudokuNative_createGame(JNIEnv *env, jobject thiz, jint difficulty) {
    try {
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_terabyte_sudokucppgame_core_data_SudokuNative_makeTurn(JNIEnv *env, jobject thiz, jlong ptr, jint row,
...
Java_com_terabyte_sudokucppgame_core_data_SudokuNative_getMistakes(JNIEnv* env, jobject thiz, jlong ptr) {
    GameHandler* handler = reinterpret_cast<GameHandler*>(ptr);
    return handler->getAmountMistakes();
}

extern "C" JNIEXPORT jboolean JNICALL
Java_com_terabyte_sudokucppgame_core_data_SudokuNative_isVictory(JNIEnv* env, jobject thiz, jlong ptr) {
    GameHandler* handler = reinterpret_cast<GameHandler*>(ptr);
    return handler->isVictory() ? JNI_TRUE : JNI_FALSE;
}

extern "C" JNIEXPORT jintArray JNICALL
Java_com_terabyte_sudokucppgame_core_data_SudokuNative_getPuzzleField(JNIEnv* env, jobject thiz, jlong ptr) {
    GameHandler* handler = reinterpret_cast<GameHandler*>(ptr);
...
Java_com_terabyte_sudokucppgame_core_data_SudokuNative_deleteGame(JNIEnv* env, jobject thiz, jlong ptr) {
    GameHandler* handler = reinterpret_cast<GameHandler*>(ptr);
    delete handler;
}